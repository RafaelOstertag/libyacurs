        ...
        namespace VPACK {
                ...
                public:
                    ...
                    void operator()(const WidgetBase* w) {
                        ...
                        __size_max.cols(std::max(w->size_hint().cols(),
                                                 __size_max.cols() ) );
                        __size_max.rows(
                            w->size_hint().rows() + __size_max.rows() );
                    }
            ...
            class VSetSizeAvail {
                ...
                public:
                    ...
                    VSetSizeAvail(const VSetSizeAvail& _s) : __avail(
                            _s.__avail) {
                    }
            ...
            class VSetSizeHinted {
                ...
                public:
                    ...
                    void operator()(WidgetBase* _w) {
                        ...
                        __size_used.rows(
                            __size_used.rows() + _w->size_hint().rows() );
                    }
            ...
            class VCalcNSetSize {
                ...
                public:
                    ...
                    void operator()(WidgetBase* _w) {
                        ...
                        __size.cols(std::max(__size.cols(),
                                             _w->size().cols() ) );
                    ...
                    void finish() {
                        ...
                        VSetSizeHinted hinted_size(std::for_each(
                                                       __hinted_widgets.begin(),
                        ...
                        // widgets.
                        Size per_dyn_widget(
                            remaining_size.rows() / __dyn_widgets.size(),
            ...
            class VCalcSizeNonDynamic {
                ...
                public:
                    ...
                    VCalcSizeNonDynamic& operator=(
                        const VCalcSizeNonDynamic& _r) {
                        __size = _r.__size;
                        __had_dynamic = _r.__had_dynamic;
                        return *this;
                    }
