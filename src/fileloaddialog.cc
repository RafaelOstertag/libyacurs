...
FileLoadDialog::FileLoadDialog(std::string _path,
    ...
    EventQueue::connect_event(EventConnectorMethod1<FileLoadDialog>(
                                  EVT_LISTBOX_ENTER, this,
                                  &FileLoadDialog::listbox_enter_handler) );
    EventQueue::connect_event(EventConnectorMethod1<FileLoadDialog>(
                                  EVT_WINDOW_CLOSE, this,
                                  &FileLoadDialog::window_close_handler) );
}

FileLoadDialog::~FileLoadDialog() {
    EventQueue::disconnect_event(EventConnectorMethod1<FileLoadDialog>(
                                     EVT_LISTBOX_ENTER, this,
                                     &FileLoadDialog::listbox_enter_handler) );
    EventQueue::disconnect_event(EventConnectorMethod1<FileLoadDialog>(
                                     EVT_WINDOW_CLOSE, this,
