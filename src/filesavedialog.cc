...
FileSaveDialog::FileSaveDialog(std::string _path,
    ...
    EventQueue::connect_event(EventConnectorMethod1<FileSaveDialog>(EVT_LISTBOX_ENTER,this,&FileSaveDialog::listbox_enter_handler));
    EventQueue::connect_event(EventConnectorMethod1<FileSaveDialog>(EVT_WINDOW_CLOSE, this, &FileSaveDialog::window_close_handler));
}

FileSaveDialog::~FileSaveDialog() {
    EventQueue::disconnect_event(EventConnectorMethod1<FileSaveDialog>(EVT_LISTBOX_ENTER,this,&FileSaveDialog::listbox_enter_handler));
    EventQueue::disconnect_event(EventConnectorMethod1<FileSaveDialog>(EVT_WINDOW_CLOSE, this, &FileSaveDialog::window_close_handler));
